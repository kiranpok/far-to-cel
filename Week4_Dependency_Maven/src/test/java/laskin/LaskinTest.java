...
public class LaskinTest {
    ...
    public void testProduct() {
        laskin.add(10);
        laskin.product(2);
        assertEquals(20, laskin.returnResult(), DELTA, "Number 10 and 2 product is wrong"); // Muokattu odotettu tulos
    }
    ...
    public void testSquareRoot() {
        laskin.squareroot(9);
        assertEquals(3.0, laskin.returnResult(), DELTA, "Square root of 9 should be 3"); // Muokattu odotettu tulos
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> laskin.squareroot(-9));
